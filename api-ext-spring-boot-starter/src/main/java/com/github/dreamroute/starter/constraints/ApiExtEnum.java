...
import com.github.dreamroute.starter.constraints.validator.ApiExtEnumValidator;
...
@Target(FIELD)
@Retention(RUNTIME)
@Repeatable(ApiExtEnum.List.class)
@Constraint(validatedBy = {ApiExtEnumValidator.class})
public @interface ApiExtEnum {
